...
const ClientDetails = () => {
    ...
    return (
        <LayOut> <div className="w-[1380px] h-[550px] absolute top-[104px] left-[80px] rounded-[10.17px] border border-[#F4EAEA] bg-white p-6 shadow-lg">
            <div className="w-[1310px] h-[40px] relative top-[6px] flex items-center justify-between px-2 border-b border-gray-100 align-middle">
            ...
            <div className="p-4 flex">
                {/* Avatar Section */}
                <div className="w-[260px] h-[69px] flex items-center gap-[12.21px] mt-[10px]">
                    <img
            ...
            <div className="ml-[33] mt-[20px]">
                ...
                {/* View More Button */}
                <button className="mt-10 px-4 py-2 bg-white border border-gray-200 text-black rounded-md flex align-middle items-center mx-auto">
                    View More
                </button>
            </div>
        </div></LayOut>

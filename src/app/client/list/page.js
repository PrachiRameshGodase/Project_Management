                                ...
                                <table className="w-full border-spacing-y-1 min-w-[1000px] border-2 border-transparent  ">
                                    <thead>
                                        <tr className="text-left m-1 text-sm uppercase text-black opacity-80 shadow-tr-border rounded-md  ">
                                            ...
                                            <th className="py-2 sm:py-3 px-2 sm:px-4  text-[12px] sm:text-[14px] rounded-t-lg">MOBILE NUMBER</th>
                                    ...
                                    <tbody>
                                        {paginatedUsers.map((user) => (
                                            <tr key={user?.id} className="cursor-pointer   hover:shadow-tr-border   rounded-md  transition-all duration-200">
                                                <td className="py-2 sm:py-3 px-2 sm:px-4  text-[13px] sm:text-[16px]  border-gray-50" onClick={() => router.push(`/client/details?id=${user.userId}`)}>{user.userId}</td>
                                                <td className="py-2 sm:py-3 px-2 sm:px-4  text-[13px] sm:text-[16px]  border-gray-50" onClick={() => router.push(`/client/details?id=${user.userId}`)}>{user.firstName}</td>
                                                <td className="py-2 sm:py-3 px-2 sm:px-4  text-[13px] sm:text-[16px]" onClick={() => router.push(`/client/details?id=${user.userId}`)}>{user.email}</td>
                                                <td className="py-2 sm:py-3 px-2 sm:px-4  text-[13px] sm:text-[16px]" onClick={() => router.push(`/client/details?id=${user.userId}`)}>{user.mobileNumber}</td>
                                                <td className="py-2 sm:py-3 px-2 sm:px-4  text-[13px] sm:text-[16px] " onClick={() => router.push(`/client/details?id=${user.userId}`)}>{user.mobileNumber}</td>
                                                <td
                                                    className="py-2 sm:py-3 px-2 sm:px-4  text-[13px] sm:text-[16px]  font-bold items-center flex align-middle"
